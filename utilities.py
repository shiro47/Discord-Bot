...
async def create_streamers_live_embeds(guild_id):
    ...
    for streamer in streamers:
        if streamers[streamer][1] in categories:
            continue
        categories.update({streamers[streamer][1]:streamers[streamer][2]})
    for category in categories:
        ...
        pos=1
        streamers_in_category={}
        for streamer in streamers:
            if streamers[streamer][1]==category:
                streamers_in_category.update({streamer:streamers[streamer][0]})
