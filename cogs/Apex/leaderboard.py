...
class ApexLegends_leaderboard(commands.Cog):
    ...
    async def register(self, interaction: discord.Interaction, platform: str, nickname: str):
        ...
        apex_db = mongo_database.apex_db(server_id=str(guild_id))
    ...
    async def configure_leaderboard(self, interaction: discord.Interaction):
        ...
        mongo_database.config_db(server_id=str(guild_id)).create_ids_for_apex_leaderboard(channel_id=channel_id, IDs=message_IDs)
    ...
    async def update_leaderboard(self):
        ...
        for guild in self.bot.guilds:
            config = mongo_database.config_db(server_id=str(guild.id)).check_ids_for_apex_leaderboard()
            if config!=False:
